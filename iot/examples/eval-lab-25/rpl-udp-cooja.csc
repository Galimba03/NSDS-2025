...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/contiking-group09/udp-server.c</source>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/contiking-group09/udp-client.c</source>
    ...
    <motetype>
      ...
      <description>client_read</description>
      <source>[CONTIKI_DIR]/examples/contiking-group09/udp-client_read.c</source>
      <commands>make udp-client_read.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        ...
        <x>83.54433039875852</x>
        <y>61.13985705241226</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>59.67718546935662</x>
        <y>32.69239023269785</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>103.05006974833762</x>
        <y>96.86833072085278</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>3.8738955702189743 0.0 0.0 3.8738955702189743 -116.25110212902382 -44.98507000129091</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>

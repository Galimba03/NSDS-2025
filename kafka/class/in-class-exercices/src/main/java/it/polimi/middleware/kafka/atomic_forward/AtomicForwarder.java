...
public class AtomicForwarder {
    ...
    // Reads and puts into different topics -> should not create duplicate or skip messages
    private static final String defaultInputTopic = "topicA";
    private static final String defaultOutputTopic = "topicB";

    private static final String serverAddr = "localhost:9092";
    // We need to set is as a transactional procuder
    ...
    public static void main(String[] args) {
        ...
        consumerProps.put(ConsumerConfig.ISOLATION_LEVEL_CONFIG, "read_committed"); // read messages that were pushed and committed
        ...
        producer.initTransactions(); // begin of a transaction

        while (true) {
            final ConsumerRecords<String, String> records = consumer.poll(Duration.of(5, ChronoUnit.MINUTES));
            producer.beginTransaction(); // start a new transaction
            ...
            final Map<TopicPartition, OffsetAndMetadata> map = new HashMap<>(); // Data structure that contains the latest partition for each topic
            ...
            producer.sendOffsetsToTransaction(map, consumer.groupMetadata()); // commit as part of this transaction these topics

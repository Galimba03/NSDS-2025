...
public class BasicConsumerManual {
    ...
    private static final boolean autoCommit = false; // Offset are not automatically committed
    private static final int commitEvery = 50;

    // Default is "latest": try "earliest" instead
    private static final String offsetResetStrategy = "earliest"; // TODO: ask why if it's in "latest" it is not working
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            for (final ConsumerRecord<String, String> record : records) {
                ...
                // This is the part of the code that commit the offset
                numConsumed++;

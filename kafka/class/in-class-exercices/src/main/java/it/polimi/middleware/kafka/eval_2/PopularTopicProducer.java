...
public class PopularTopicProducer {
    private static final List<String> TOPICS = List.of("inputTopic", "inputTopic1", "inputTopic2");
    ...
    public static void main(String[] args) {
        ...
        for (int i=0; i<numMessages; i++) {
            final String randomTopic = TOPICS.get(r.nextInt(TOPICS.size()));
            final String key = "Key" + r.nextInt(1000);
            final int value = r.nextInt(20);

            final ProducerRecord<String, Integer> record = new ProducerRecord<>(randomTopic, key, value);

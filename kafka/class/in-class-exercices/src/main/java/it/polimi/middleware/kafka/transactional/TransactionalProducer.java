...
public class TransactionalProducer {
    ...
    private static final String transactionalId = "myTransactionalId"; // need to create a transactional Id
    ...
    public static void main(String[] args) {
        ...
        props.put(ProducerConfig.TRANSACTIONAL_ID_CONFIG, transactionalId); // using the transactionalId as parameter of configuration
        ...
        // Do this after the creation of the producer
        producer.initTransactions();

        // From this point, the producer can begin transactions or stop them
        for (int i = 0; i < numMessages; i++) {
            ...
            if (i % 2 == 0) {
                ...
                producer.flush();
                producer.abortTransaction(); // Abort transaction
            }
